...
const InfoBoard: FC<IInfoBoardProps> = (props: IInfoBoardProps) => {
	const styleInfoBoard = (): CSSProperties => ({
		width: `100%`,
	...
	return (
		<div className="info-board" style={styleInfoBoard()}>
			...
			<div className="info-board-instructions">
				<p>
					You must navigate the ant around the board using the paths. Falling into an empty block
					will kill your ant. Use the holes around the edges of the board to jump to the opposite
					block.
				</p>
			</div>
